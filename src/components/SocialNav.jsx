    ...
    <div className="fixed bottom-0 left-12">
      <ul className="w-fit p-4 space-y-6 text-[#a8b2d1]">
        <li className="w-5 h-5 hover:-translate-y-1 transition-all duration-500 hover:text-[#64ffdb]">
          <a
            href="https://github.com/Fahim-Arefin"
            aria-label="GitHub"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="w-5 h-5 hover:-translate-y-1 transition-all duration-500 hover:text-[#64ffdb]">
          <a
            href="https://www.linkedin.com/in/minhajul-arefin-fahim-854396288/"
            aria-label="Linkedin"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li className="w-5 h-5 hover:-translate-y-1 transition-all duration-500 hover:text-[#64ffdb]">
          <a
            href="https://www.instagram.com/fahim_08/"
        ...
        <li className="h-[100px] bg-[#a8b2d1] w-[1px] mx-auto"></li>
      </ul>
    </div>
  );
}
