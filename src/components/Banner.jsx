function Banner() {
  return (
    <div className="container mx-auto mt-12 md:mt-44 py-4">
      <div className="px-4 md:px-24 lg:px-32 xl:px-60 space-y-4 md:space-y-7">
        <p className="tracking-wide text-[#64ffda] text-lg font-Roboto">
          Hi, my name is
        </p>
        ...
        <p className="text-[#7b86a3] text-sm md:text-[15px] lg:text-[18px] md:w-[70%] lg:w-[65%] font-inter leading-6 lg:leading-7">
          Dedicated and reliable web enthusiast eager to launch my career as a
          MERN stack developer. Quick thinker, logical, and a team player ready
          to contribute effectively. Excited for continuous learning and
          professional growth.
        </p>
        <div>
          <a
